...
//    $(".show-popover").popover();
    ...
    var n = function () {
        ...
        $("#sidebar.sidebar-fixed .nav").slimScroll({height: e + "px", position: "left"})
    };
    n();
    ...
    if ($(".tile-active").size() > 0) {
        ...
        var u = function (e, t, n, r) {
            $(e).children(".tile").animate({top: "-=" + r + "px"}, s);
            setTimeout(function () {
                a(e, t, n, r)
            }, n + s)
        };
    ...
    if (jQuery().chosen) {
        $(".chosen").chosen({no_results_text: "Oops, nothing found!", width: "100%"});
        $(".chosen-with-diselect").chosen({allow_single_deselect: true, width: "100%"})
    }
    ...
    if (jQuery().validate) {
        ...
        var l = $("#validation-form").validate({errorElement: "span", errorClass: "help-block", errorPlacement: function (e, t) {
            if (t.parent(".input-group").length) {
                e.insertAfter(t.parent())
            } else {
                e.insertAfter(t)
            }
        }, focusInvalid: false, ignore: "", invalidHandler: function (e, t) {
