    ...
    private void buildSecureRandom() {
        try {
            ...
            throw new GoogleAuthenticatorException(
                    "Could not initialise SecureRandom with the specified algorithm: "+ this.algorithm, e);
        } catch (NoSuchProviderException e) {
            throw new GoogleAuthenticatorException(
                    "Could not initialise SecureRandom with the specified provider" + this.provider, e);
        }
    }
